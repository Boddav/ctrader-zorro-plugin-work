...
// Forward declaration - defined in symbols.h
struct SymbolInfo;
...
struct GLOBAL {
    ...
    // WebSocket handles (from kiindulasi2.txt)
    HINTERNET hSession;
    HINTERNET hConnect;
    ...
    // Symbol and trade maps (like kiindulo.txt)
...
constexpr ULONGLONG PING_INTERVAL_MS = 10000;
