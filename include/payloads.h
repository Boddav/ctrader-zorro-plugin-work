...
enum class PayloadType : int {
    ...
    PROTO_OA_DEAL_LIST_BY_POSITION_ID_REQ = 2135,
    PROTO_OA_DEAL_LIST_BY_POSITION_ID_RES = 2136,
    ...
    PROTO_OA_CASHFLOW_HISTORY_LIST_REQ = 2143,
    PROTO_OA_CASHFLOW_HISTORY_LIST_RES = 2144,
    ...
    PROTO_OA_SUBSCRIBE_DEPTH_QUOTES_REQ = 2155,
    PROTO_OA_SUBSCRIBE_DEPTH_QUOTES_RES = 2156,
    PROTO_OA_UNSUBSCRIBE_DEPTH_QUOTES_REQ = 2157,
    PROTO_OA_UNSUBSCRIBE_DEPTH_QUOTES_RES = 2158,
    PROTO_OA_DEPTH_EVENT = 2159,
    ...
    PROTO_OA_SUBSCRIBE_LIVE_TRENDBAR_REQ = 2165,
    PROTO_OA_UNSUBSCRIBE_LIVE_TRENDBAR_REQ = 2166,
    ...
    PROTO_OA_POSITION_LIST_REQ = 2177,
    PROTO_OA_POSITION_LIST_RES = 2178,
    PROTO_OA_POSITION_UNREALIZED_PNL_REQ = 2179,
    PROTO_OA_POSITION_UNREALIZED_PNL_RES = 2180,
    PROTO_OA_DEAL_OFFSET_LIST_REQ = 2181,
    PROTO_OA_DEAL_OFFSET_LIST_RES = 2182,
    PROTO_OA_DEAL_BY_ID_REQ = 2183,
    PROTO_OA_DEAL_BY_ID_RES = 2184,
    PROTO_OA_GET_DEALS_FROM_DEAL_ID_REQ = 2185,
    PROTO_OA_GET_DEALS_FROM_DEAL_ID_RES = 2186,
    PROTO_OA_GET_LIMITED_DEALS_FROM_DEAL_ID_REQ = 2187,
    PROTO_OA_GET_LIMITED_DEALS_FROM_DEAL_ID_RES = 2188
};